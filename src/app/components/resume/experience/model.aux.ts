...
var imageReq = require.context('./../../../../images', true, /^\.\/.*\.jpg$/);

let insa = imageReq('./insa.jpg');
let ust = imageReq('./ustGlobal.jpg');
let ibm = imageReq('./ibm.jpg');
// let insa = require('file!./../../../../images/insa.jpg');
// let ust = require('file!./../../../../images/ustGlobal.jpg');
// let ibm = require('file!./../../../../images/ibm.jpg');

export const experienceModel: Experience[] = [{
        image: insa,
        company: "INSA",
        ...
        projects: [{
            title: "Desktop Channel - IBM  BTT",
            client: "Banco Popular",
            since: new Date("June 23, 2015"),
            until: new Date(),
            desc: "Adapt the tool <b>IBM BTT </b>to the client’s needs so the developers create  their own transactions flows and views. Creating fully customized, reusable and easy configurable widgets, mapping functions and lastly but not less importantly web services.",
            technologies: [{
                    name: "CSS 3",
                    desc: "Add Style to customized components, add effects and create the application's layout"
                },
                {
                    name: "HTML 5",
                    desc: ""
                ...
                {
                    name: "Javascript - Frameworks: Dojo v1.8 & v1.10",
                    desc: ""
                },
                {
                ...
                {
                    name: "IBM Websphere Multichannel Bank Transformation Toolkit (BTT)",
                    desc: ""
                },
                {
                    name: "IBM Websphere Application Server (WAS) V. 7.0",
                    desc: ""
                },
                {
                    name: "IBM Rational Application Developer (RAD) Vs. 8 & 9.",
                    desc: ""
                }
            ],
        }],
    ...
    },
    {
        ...
        projects: [{
                ...
                technologies: [{
                        name: "TIBCO Business Events",
                        desc: ""
                    },
                    {
                        name: "TIBCO Business Works",
                        desc: ""
                    },
                    {
                        name: "TIBCO EMS",
            ...
            },
            {
                ...
                technologies: [{
                    ...
                    {
                        name: "SOAP UI",
                        desc: "Used to test the webservice"
                    },
                    {
                        name: "Oracle SQL",
                        desc: ""
            ...
            },
            {
                ...
                technologies: [{
                    ...
                    {
                        name: "Javascript - Frameworks: Jquery | Highcharts",
                        desc: ""
                    },
                    {
                        name: "Spring MVC",
    ...
    },
    {
        ...
        projects: [{
                ...
                technologies: [{
                    ...
                    {
                        name: "Javascript - Frameworks: Dojo v1.7",
                        desc: ""
                    },
                    {
                        name: "IBM BPM 8.0 - Process Designer",
                        desc: ""
                    },
                ]
            ...
            },
            {
                ...
                technologies: [{
                    ...
                    {
                        name: "Javascript - Frameworks: Dojo v1.6",
                        desc: ""
                    },
                    {
                        name: "J2ee",
            ...
            },
            {
                ...
                since: new Date("June 01, 2011"),
                until: new Date("February 01, 2012"),
                desc: "Web application. Involved in the development and test phase of the project. Developed the backend and the frontend of specific use cases beginning with the creation of store procedures and functions, through a custom architecture that ended in the presentation layer using JSP templates, HTML 5, Dojo and Struts. The Project was developed using a Custom Agile Methodoly.",
                technologies: [{
                        name: "CSS 3",
                        desc: "Add Style to customized components, add effects and create the application's layout"
                    },
